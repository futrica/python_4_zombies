...
# A. near_ten
# Seja um n não negativo, retorna True se o número está a distancia de
# pelo menos dois de um multiplo de dez. Use a funçao resto da divisao.
# near_ten(12) -> True
# near_ten(17) -> False
# near_ten(19) -> True
def near_ten(n):
...
# Se algum numero aparecer repetido ele nao conta na soma
# lone_sum(1, 2, 3) -> 6
# lone_sum(3, 2, 3) -> 2
# lone_sum(3, 3, 3) -> 0
def lone_sum(a, b, c):
...
# Se aparecer um 13 ele nao conta e todos os da sua direita também
# lucky_sum(1, 2, 3) -> 6
# lucky_sum(1, 2, 13) -> 3
# lucky_sum(1, 13, 3) -> 1
def lucky_sum(a, b, c):
...
# E. count_hi
# conta o numero de vezes que aparece a string 'hi'
...
# F. cat_dog
# verifica se o aparece o mesmo numero de vezes 'cat' e 'dog'
# cat_dog('catdog') -> True
...
# assim 'coxe' ou 'coze' também sao contadas como 'code'
...
# H. end_other
# as duas strings devem ser convertidas para minusculo via lower()
...
# 13 dÃ¡ azar, vocÃª deverÃ¡ ignorar o 13 e todos os nÃºmeros Ã  sua direita
# sum13([1, 2, 2, 1]) -> 6
# sum13([1, 1]) -> 2
# sum13([1, 2, 2, 1, 13]) -> 6
# sum13([13, 1, 2, 3, 4]) -> 0
...
# L. soma_na_lista
# Verifica se um numero é soma de dois elementos distintos de uma lista
...
def fila_tijolos(n_peq, n_gra, meta):
  ...
  if total >= meta:
    ...
    if inteiro > n_gra:
      inteiro = n_gra
    if inteiro <= n_gra and resto <= n_peq:
        return True
